...
SYSTEM_PROMPT = (
    ...
    '(1) open_app to launch; (2) ui_dump to see tappable elements and their coordinates; '
    '(3) input_my_screen to act; (4) repeat from step 2 until done. '
    'Use read_my_screen mid-loop when the screen contains content uiautomator cannot see (canvas, images, web views). '
    'Always check the screen state after each action before deciding the next step — never assume an action succeeded.\n'
