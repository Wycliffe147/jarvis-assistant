...
from jarvis.tools.camera import take_photo, analyze_photo, local_ocr, read_my_screen, ocr_my_screen, screenshot_my_screen, confirm_uncompressed_upload
...
TOOLS = {
    ...
    "confirm_uncompressed_upload": confirm_uncompressed_upload,
...
confirm_uncompressed_upload()    - ONLY call this after the user EXPLICITLY agrees, in their own words, to send images/screenshots to the vision API at full size because ffmpeg isn't installed. Never call this proactively, speculatively, or as a default — analyze_photo/read_my_screen will tell you directly when this confirmation is needed and what the file size is; relay that to the user and wait for a real yes before calling this.
